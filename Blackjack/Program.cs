    ...
    internal class Program
    {
        static void Main()
        {
            ...
            while (!validAnswer)
            {
                ...
                if (!validAnswer) Console.WriteLine("Please only enter digits -- no decimals, either.");
            }
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                while (player.IsActivelyPlaying && player.Balance > 0)
                {
                    ...
                    {
                        Console.WriteLine("Security is on their way. Get out.");
        ...
        private static void UpdateDbWithException(Exception ex)
        {
            ...
            string queryString = "INSERT INTO dbo.Exception (ExceptionType, ExceptionMessage, TimeStamp) VALUES (@ExceptionType, @ExceptionMessage, @TimeStamp)";
